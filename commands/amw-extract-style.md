...
Use the `dev-browser` CLI (via `skills/amw-dev-browser/SKILL.md`) to:
...
- A `:root { ... }` oklch palette matching design-principles' `skills/amw-design-principles/color-system.md` structure (surface-0..2, text-1..3, border, primary, success/warning/danger).
