...
> [design-decision-rules.md] I. Purpose and placement · II. Rule format · III. Required dimensions · IV. Worked example — Stripe · V. Worked example — Linear · VI. Worked example — Notion · VII. The genericness test · VIII. Common failure modes
...
> [writing-voice.md] I. Principle 1 — Specific words beat generic words · II. Principle 2 — Compare to the peer category · III. Principle 3 — Document scarcity rules explicitly · IV. Principle 4 — Don'ts are half the document's value · V. Principle 5 — Semantic role names, not literal names · VI. Principle 6 — Cross-reference tokens, not raw hex · VII. Principle 7 — Document Known Gaps honestly · VIII. Sentence patterns that work · IX. Things to avoid · X. Test the result
