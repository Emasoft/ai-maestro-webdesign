...
> [TECH-brand-researcher-playbook.md] Step 1 — Identify top-N competitors · Step 2 — Extract design tokens per site · Step 3 — Cluster aesthetic positions · Step 4 — Produce DESIGN.md exemplars · Step 5 — Recommend 1–3 directions · Search query templates · Source list — GREEN vs REJECT · Traffic-light scoring · Anti-reference board (T-158)
