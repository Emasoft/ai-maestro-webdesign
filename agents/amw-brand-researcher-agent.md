...
| Running the 5-step competitor analysis recipe (identify → extract → cluster → DESIGN.md exemplars → recommend directions) | [TECH-brand-researcher-playbook](../skills/amw-design-principles/references/TECH-brand-researcher-playbook.md) | Read for the mechanical recipe, search-query templates, GREEN/REJECT source list, traffic-light scoring, and anti-reference board (blur-test + "What This Brand Fights" field). Apply judgment when the recipe doesn't fit cleanly (e.g., single-brand audit instead of competitor set). | - |
> [TECH-brand-researcher-playbook.md] What this is · Step 1 — Identify top-N competitors · Step 2 — Extract design tokens per site · Step 3 — Cluster aesthetic positions · Step 4 — Produce DESIGN.md exemplars · Step 5 — Recommend 1–3 directions · Search query templates · Source list — GREEN vs REJECT · Traffic-light scoring · Anti-reference board (T-158) · Cross-references
