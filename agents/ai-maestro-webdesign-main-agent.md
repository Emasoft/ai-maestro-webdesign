...
> [TECH-dial-configuration.md] What this is · Why dials, not adjectives · The six dials · Natural-language → dial mapping · Design-read signal → dial inference · Variant spread rule · Dial conflicts · Default dial bundles by archetype · Cross-references
...
> [TECH-orchestration-conflict-resolution.md] What it does · When this is relevant · The tiebreak hierarchy · Decision tree · Confidence-score interpretation · Worked example — good case · Worked example — bad case · Recording the decision · What this protocol does NOT do · Cross-references
...
> [TECH-orchestration-parallel-dispatch.md] What it does · When this is relevant · The dispatch decision · Three-question algorithm · Parallel-eligible patterns · Sequential-required patterns · Worked example — good case · Worked example — bad case · Concurrency budget · Failure handling in parallel batches · What this protocol does NOT do · Cross-references
...
> [TECH-orchestration-checkpoint-protocol.md] What it does · When this is relevant · Checkpoint vs satisfaction gate · The four mandatory checkpoint triggers · Checkpoint message format · Decision tree for checkpoint decisions · Worked example — good case · Worked example — bad case · Recording the checkpoint · What this protocol does NOT do · Cross-references
...
> [TECH-orchestration-recovery-from-veto.md] What it does · When this is relevant · The three recovery options · Decision tree for picking a recovery path · Recovery option A — user override · Recovery option B — re-author the offending element · Recovery option C — drop the offending element · Worked example — good case · Worked example — bad case · Recording the recovery · What this protocol does NOT do · Cross-references
