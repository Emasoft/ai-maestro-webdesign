...
- `TECH-4-phase-mandatory-workflow.md` — the overall pipeline
- `TECH-use-case-document-schema.md` — the file shape written to disk
- `TECH-mermaid-flowchart-screen-map.md` — Phase 2 consumes these use
  cases
