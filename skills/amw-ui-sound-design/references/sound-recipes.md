...
*Source: dannyjpwilliams/ui-sound-design-skill, MIT (© 2026 Danny Williams). Original at https://github.com/dannyjpwilliams/ui-sound-design-skill (verify upstream URL via the source repo's package.json if package metadata exists; otherwise leave the bare slug as the upstream identity).*
