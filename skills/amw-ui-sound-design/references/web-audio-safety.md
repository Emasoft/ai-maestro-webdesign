...
<!-- Adapted for ai-maestro-webdesign plugin: paths to `references/web-audio-api.md` rewritten to `references/web-audio-building-blocks.md`; paths to `references/tone-js.md` rewritten to `references/web-audio-building-blocks.md`; `tools/analyze-sound.mjs` rewritten to `../../../bin/amw-sound-analyze.mjs`. -->
