...
- [SKILL](../../amw-svg-creator/SKILL.md) — GATED single-SVG producer (icons / logos / patterns / animations)
- [SKILL](../../amw-diagram-svg/SKILL.md) — freeform node-and-edge SVG
- [SKILL](../../amw-diagram-architecture/SKILL.md) — layered architecture → JSON / SVG / PNG / Mermaid
- [SKILL](../../amw-diagram-editorial/SKILL.md) — editorial HTML+SVG producer (13 archetypes)
- [SKILL](../../amw-ascii-to-svg/SKILL.md) — ASCII → SVG parse/classify/route
- [advanced-techniques](../../amw-svg-creator/references/advanced-techniques.md) — filter / gradient / animation cookbook
