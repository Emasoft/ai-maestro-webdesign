...
- [community-9-section-spec](../../amw-design-md-spec/references/community-9-section-spec.md) — V2 source format
...
- [canonical-spec-google-alpha](../../amw-design-md-spec/references/canonical-spec-google-alpha.md) — V1 target format
