...
When a project uses DESIGN.md AND has `CLAUDE.md` snippet from `templates/claude-md-snippet.md`, the wireframe-builder reads BOTH:
...
- `./templates/claude-md-snippet.md` — coupled CLAUDE.md
