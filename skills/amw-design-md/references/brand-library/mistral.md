<!-- Sourced verbatim from VoltAgent/awesome-design-md (MIT, 2026): references/design-md/mistral.ai/DESIGN.md -->
<!-- Curated into the amw-design-md brand library 2026-05-26. Use as an authoring exemplar, not as the user's project file. -->
