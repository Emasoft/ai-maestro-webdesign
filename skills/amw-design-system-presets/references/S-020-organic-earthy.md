...
- Source: `frontend-design-main/SKILL.md` (Anchor 7 — Organic); `frontend-design-engineer-skill-main/.../visual-directions.md` (Organic direction); `design-system-is-all-you-need-main/` (organic token system)
