...
- **Source attribution:** `reports/batch9-harvest/styles-A.md` §Hand-draw (Stitch Preset); `reports_dev/batch9/extracted/design-forge-main/references/discovery-framework.md`. License MIT (inferred from source repo).
