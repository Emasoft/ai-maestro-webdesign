...
- **Source attribution:** `reports/batch9-harvest/styles-A.md` §Motion (Stitch Preset); `design-forge-main/references/discovery-framework.md`. License MIT (inferred from source repo).
